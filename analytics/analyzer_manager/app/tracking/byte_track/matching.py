...
def iou_distance(atracks, btracks):
    ...
    cost_matrix = 1 - _ious
    cost_matrix = class_filter_cost_matrix(cost_matrix, acls, bcls)

    return cost_matrix

def class_filter_cost_matrix(cost_matrix, acls, bcls):
    '''
    ...
    cost_matrix[diff_cls_mask] = 1. #   maximal cost for different class
