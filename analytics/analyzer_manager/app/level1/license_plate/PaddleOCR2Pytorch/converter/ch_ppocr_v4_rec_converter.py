...
if __name__ == '__main__':
    ...
    print(f'done. {save_name} is saved.')


# python ./converter/ch_ppocr_v4_rec_converter.py --yaml_path ./configs/rec/PP-OCRv4/en_PP-OCRv4_rec_LPR.yml --src_model_path en_PP-OCRv4_rec_train_dir


# python ./tools/infer/predict_rec.py \
#     --image_dir /home/noamr/analytics_research/our_ocr/tmp_images/images/attributes-1723409782062-4602-vehicle-1.jpg \
