"""CIoU-capable IoU distance (vendored from analytics byte_sreid matching).

Used by ByteTrackerPlusAug19 when use_ciou=True. Do not edit analytics/.
"""
...
chi2inv95 = None  # unused by iou_distance / fuse_score path
